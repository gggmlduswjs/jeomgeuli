...
export default function Home() {
  ...
  // 온보딩 음성 안내
  useEffect(() => {
    const onboardingMessage = "시각장애인 학습 앱, 점글이입니다. 메인화면에 점자학습, 정보탐색, 복습하기, 자유변환 모드가 있습니다. 모드를 선택해주세요.";
    
    // 사용자 상호작용 후 음성 안내 (브라우저 정책)
  ...
  return (
    <AppShellMobile title="점글이" className="relative">
      ...
      <div className="mb-6">
        <button
          onClick={() => speak("시각장애인 학습 앱, 점글이입니다. 메인화면에 점자학습, 정보탐색, 복습하기, 자유변환 모드가 있습니다. 모드를 선택해주세요.")}
